...
// import { TypeContratEnum, StatutOffre, ModeTravail } from '../../Models/enums.model';
...
//     return enumItem ? enumItem[0] : 'Unknown'; // Return 'Unknown' if no match is found
//   }
...
//       this.searchOffres(value);
//     });
//   }

//   // Load all offres initially
//   loadOffres(): void {
...
//   // Search offres using backend API
//   searchOffres(searchParams: any): void {
//     const { titre, specialite, typeContrat, statut } = searchParams;

//     // If all fields are empty, reset to full list
//     if (!titre && !specialite && !typeContrat && !statut) {
...
//     this.offreService.searchOffres(titre, specialite, typeContrat, statut).subscribe({
//       next: (response: any) => {
...
//   // Update paginated offres based on current page
...
//   // Delete an offre with SweetAlert confirmation
